...
OMEGA = float(OMEGAS[31])   # high frequency, c ~ 500
NST, NREP, CH = 32, 150, 15
...
json.dump(rows, open(os.path.join(OUT, "m_sweep_estep_hiw.json"), "w"), indent=1)
print("\nwrote m_sweep_estep_hiw.json")
